...
import com.thinkwise.cryptomachine.algorithms.TwoSquare;

public class TwoSquareActivity extends AppCompatActivity {

    private TwoSquare twoSquare;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_twosquare);

        twoSquare = new TwoSquare();
        ...
        encryptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String result = twoSquare.encrypt(text, key);
        ...
        decryptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String text = inputText.getText().toString();
                String key = inputKey.getText().toString();
                String result = twoSquare.decrypt(text, key);
        ...
        cryptoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                resultText.setText("Cryptoanalysis for Two-Square Cipher is context-dependent.");
            }
        });
