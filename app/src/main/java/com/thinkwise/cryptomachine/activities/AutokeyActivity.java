...
import com.thinkwise.cryptomachine.algorithms.Autokey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        encryptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String result = autokey.encrypt(text, key);
        ...
        decryptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String text = inputText.getText().toString();
                String key = inputKey.getText().toString();
                String result = autokey.decrypt(text, key);
        ...
        cryptoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                resultText.setText("Cryptoanalysis for Autokey Cipher is context-dependent.");
            }
        });
