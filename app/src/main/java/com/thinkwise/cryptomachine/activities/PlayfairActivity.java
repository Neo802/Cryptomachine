...
import com.thinkwise.cryptomachine.algorithms.Playfair;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        encryptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String result = playfair.encrypt(text, key);
        ...
        decryptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String text = inputText.getText().toString();
                String key = inputKey.getText().toString();
                String result = playfair.decrypt(text, key);
        ...
        cryptoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                resultText.setText("Cryptoanalysis for Playfair Cipher is complex and requires contextual analysis.");
            }
        });
